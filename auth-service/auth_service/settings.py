...
SECRET_KEY = 'django-insecure-%0%@1s59^_h0ukpm0^(^$c!jxugupv^8n%rk3cys_jjdvl-aav'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication', # Clase que maneja la autenticación JWT
    ),
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='main_db'),
